...
router.post('/verify', authenticateToken, passwordChangeLimiter, function (req, res) {
  controller.verifyCurrentPassword(req, res);
});

router.put('/update', authenticateToken, passwordChangeLimiter, function (req, res) {
  controller.updateUserPassword(req, res);
});

router.put('/', authenticateToken, passwordChangeLimiter, function (req, res) {
