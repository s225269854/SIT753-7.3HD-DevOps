...
| Monitor\_&_Logging/loginLogger.js | Authentication Log      | Login event                                | user_id, ip_address, user_agent     | Yes           | Supabase table `audit_logs`                             | Properly persisted and structured                           |
