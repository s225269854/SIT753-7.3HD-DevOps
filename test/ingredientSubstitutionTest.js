...
describe('Ingredient Substitution API', () => {
  ...
  describe('GET /api/substitution/ingredient/:ingredientId', () => {
    it('should return substitutions for a valid ingredient ID', async () => {
      ...
      const res = await chai.request(server).get('/api/substitution/ingredient/1');
    ...
    it('should handle filtering by allergies', async () => {
      ...
      const mockSubstitutes = [{ id: 5, name: 'Almond Milk', category: 'Dairy' }];
      ...
      const res = await chai.request(server).get('/api/substitution/ingredient/1?allergies=2,3');
    ...
    it('should handle filtering by dietary requirements', async () => {
      ...
      const mockSubstitutes = [{ id: 7, name: 'Lentils', category: 'Protein' }];
    ...
    it('should return 404 for non-existent ingredient', async () => {
      ...
      // Make the API request
      const res = await chai.request(server).get('/api/substitution/ingredient/999');
    ...
    it('should return 400 for invalid ingredient ID', async () => {
      ...
      const res = await chai.request(server).get('/api/substitution/ingredient/invalid');
