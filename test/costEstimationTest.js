    ...
    it('should return 200, return minimum/maximum cost and ingredients for recipe 261', (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          expect(res.body).to.have.all.keys('info', 'low_cost', 'high_cost');
          expect(res.body.info).to.have.all.keys(
            'estimation_type',
      ...
      chai
        ...
        .end((err, res) => {
          ...
          expect(res.body)
            .to.have.property('error')
            .that.equals(
              `Ingredient ${exclude_id.toString()} not found in recipe, can not exclude`
            );
          done();
        });
    });
