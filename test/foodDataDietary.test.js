...
describe('DietaryRequirements: Get All', () => {
  it('should return 200 and a list of dietary requirements', async () => {
    const res = await request(BASE_URL).get('/api/fooddata/dietaryrequirements');
  ...
  it('should return 404 for an invalid endpoint', async () => {
    const res = await request(BASE_URL).get('/api/fooddata/dietaryrequirements123'); // wrong route
