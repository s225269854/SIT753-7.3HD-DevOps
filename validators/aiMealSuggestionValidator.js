...
const addAiMealSuggestionValidation = [
  body('meal_type')
    .notEmpty()
    .withMessage('meal_type is required')
    .isString()
    .withMessage('meal_type must be a string')
  ...
  body('ingredients.*.item')
    .optional()
    .isString()
    .withMessage('each ingredient item must be a string'),

  body('ingredients.*.amount')
    .optional()
    .isString()
    .withMessage('each ingredient amount must be a string'),
];
